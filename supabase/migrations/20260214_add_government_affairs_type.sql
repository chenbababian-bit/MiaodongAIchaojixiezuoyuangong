-- 添加政务公文类型到conversations表的CHECK约束
...
CHECK (type IN (
  ...
  -- 项目管理类型
  'project-management-startup-report',
  ...
  -- 个人发展类型
  'personal-development-resume-optimization-job',
  ...
  'personal-development-ability-assessment',
  ...
  'personal-development-mentor-guidance',
