...
import { marketAnalysisTemplates } from "@/lib/marketing-templates";
...
export function MarketAnalysisWritingPage() {
  const router = useRouter();
  const searchParams = useSearchParams();
  const templateTitle = searchParams.get("title") || "市场分析";
  const templateId = searchParams.get("template") || "10101";
  const source = searchParams.get("source") || "hot"; // 获取source参数

  // 市场分析模块的类型映射函数
  const getMarketAnalysisTypeByTemplateId = (templateId: string): ConversationType => {
    const mapping: Record<string, ConversationType> = {
      '10101': 'market-analysis-trend-report',
      '10102': 'market-analysis-consumer-behavior',
      '10103': 'market-analysis-brand-awareness',
      '10104': 'market-analysis-brand-loyalty',
      '10105': 'market-analysis-segmentation',
      '10106': 'market-analysis-industry-benchmark',
      '10107': 'market-analysis-brand-equity',
      '10108': 'market-analysis-media-consumption',
      '10109': 'market-analysis-brand-influence',
      '10110': 'market-analysis-competitor',
      '10111': 'market-analysis-opportunity-threat',
      '10112': 'market-analysis-swot',
      '10113': 'market-analysis-pestle',
    };
    return mapping[templateId] || 'market-analysis-trend-report';
  };
    ...
    if (source === "hot") {
      ...
      switch (platform) {
        case "market-analysis":
          return marketAnalysisTemplates.map((t: any) => ({
            id: t.id,
  ...
  useEffect(() => {
    const loadHistory = async () => {
      ...
      try {
        // 根据当前模板ID获取对应的子类型
        const conversationType = getMarketAnalysisTypeByTemplateId(activeTemplate.toString());
  ...
  const getWelcomeMessage = (templateId: string): string => {
    ...
    const welcomeMessages: Record<string, string> = {
      "10101": `您好！我是您的市场趋势分析大师，拥有50年落地项目经验，专注于品牌市场分析、消费者洞察、竞争格局研判和商业机会挖掘。

我能为您提供：
1. 市场洞察 - 深度分析行业趋势、市场规模、增长驱动因素
2. 竞争分析 - 构建完整的竞争格局地图
3. 消费者研究 - 洞察目标客群的需求和决策路径
4. 趋势预判 - 预测未来3-5年的市场演变方向

请告诉我您目前面临的最核心的市场或品牌挑战是什么？`,
      "10102": `您好！我是您的消费者行为研究专家，拥有50年跨行业项目落地经验。
...
- 当前面临的最核心挑战是什么？
- 您希望优先解决哪些问题？`,
      "10103": `您好！我是您的品牌认知度调查专家，拥有50年实战项目经验。

我能帮助您：
1. 认知度诊断 - 科学评估品牌在目标市场的知名度、美誉度和忠诚度
2. 调查方案设计 - 量身定制定量、定性或混合型研究方案
3. 竞争对标分析 - 对比竞品表现，找出差距和机会点
4. 策略制定 - 基于数据制定品牌提升策略

请告诉我：
- 您的品牌所处的行业和发展阶段？
- 您希望通过认知度调查解决什么问题？`,
      "10104": `您好！我是您的品牌忠诚度测量专家，专注于帮助企业建立科学的忠诚度测量体系。

我能为您提供：
1. 忠诚度测量体系设计 - NPS/CES/CSAT/CLV等指标体系
2. 客户洞察与细分 - RFM分析、客户旅程地图、流失预警
3. 策略制定与优化 - 会员体系设计、激励机制优化
4. 项目落地支持 - 详细实施路线图和KPI监控

请告诉我：
- 您的企业处于什么行业？
- 当前在品牌忠诚度管理方面遇到了什么挑战？`,
      "10105": `您好！我是拥有50年实战经验的市场细分报告专家，精通STP理论、数据分析及商业落地。
...
- 当前面临的最大难题是什么？
- 您希望通过市场细分解决什么问题？`,
      "10106": `您好！我是您的行业基准分析专家，拥有50年实战经验。我能帮您进行行业对标分析，识别差距和改进机会。请告诉我您所在的行业和想要对标的竞品。`,
      "10107": `您好！我是您的品牌资产评估专家，拥有50年实战经验。我能帮您全面评估品牌价值，识别品牌资产的优势和不足。请告诉我您的品牌和评估目的。`,
      "10108": `您好！我是您的媒体消费习惯研究专家，拥有50年实战经验。我能帮您深入了解目标受众的媒体消费行为和偏好。请告诉我您的目标受众和研究目的。`,
      "10109": `您好！我是您的品牌影响力评估专家，拥有50年实战经验。我能帮您全面评估品牌在市场中的影响力和地位。请告诉我您的品牌和评估需求。`,
      "10110": `您好！我是您的竞品分析专家，拥有50年实战经验。我能从品牌、产品、市场策略多维度深度解剖竞品。请告诉我您所在的行业和想要分析的竞品。`,
      "10111": `您好！我是您的市场机会与威胁分析专家，拥有50年实战经验。我能帮您识别市场中的机会和潜在威胁。请告诉我您所在的行业和关注的市场领域。`,
      "10112": `您好！我是您的SWOT分析专家，拥有50年实战经验。我能帮您全面分析企业的优势、劣势、机会和威胁。请告诉我您的企业和分析目的。`,
      "10113": `您好！我是您的PESTLE分析专家，拥有50年实战经验。我能帮您从政治、经济、社会、技术、法律、环境六个维度分析宏观环境。请告诉我您所在的行业和分析需求。`
    };
    return welcomeMessages[templateId] || welcomeMessages["10101"];
  };

  // 初始化欢迎消息（所有市场分析子类型）
  useEffect(() => {
    const marketAnalysisTemplateIds = ["10101", "10102", "10103", "10104", "10105", "10106", "10107", "10108", "10109", "10110", "10111", "10112", "10113"];
    if (marketAnalysisTemplateIds.includes(templateId) && messages.length === 0) {
      setMessages([{
        id: 'welcome',
        role: 'assistant',
  ...
  const getApiEndpoint = (templateId: string): string => {
    switch (templateId) {
      case "10101": return "/api/market-analysis/trend-report";
      case "10102": return "/api/market-analysis/consumer-behavior";
      case "10103": return "/api/market-analysis/brand-awareness";
      case "10104": return "/api/market-analysis/brand-loyalty";
      case "10105": return "/api/market-analysis/segmentation";
      case "10106": return "/api/market-analysis/industry-benchmark";
      case "10107": return "/api/market-analysis/brand-equity";
      case "10108": return "/api/market-analysis/media-consumption";
      case "10109": return "/api/market-analysis/brand-influence";
      case "10110": return "/api/market-analysis/competitor";
      case "10111": return "/api/market-analysis/opportunity-threat";
      case "10112": return "/api/market-analysis/swot";
      case "10113": return "/api/market-analysis/pestle";
      default: return "/api/market-analysis/trend-report";
    }
  };
  ...
  const handleCommunicationNewConversation = () => {
    ...
    const marketAnalysisTemplateIds = ["10101", "10102", "10103", "10104", "10105", "10106", "10107", "10108", "10109", "10110", "10111", "10112", "10113"];
    if (marketAnalysisTemplateIds.includes(templateId)) {
      setMessages([{
        id: 'welcome-' + Date.now(),
        role: 'assistant',
        content: getWelcomeMessage(templateId),
  ...
  return (
    <div className="flex h-[calc(100vh-56px)]">
      {["10101", "10102", "10103", "10104", "10105", "10106", "10107", "10108", "10109", "10110", "10111", "10112", "10113"].includes(templateId) ? (
