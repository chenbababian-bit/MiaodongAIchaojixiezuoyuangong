...
export function ReportWritingPage() {
  ...
  const getWelcomeMessage = (templateId: string): string => {
    ...
    const welcomeMessages: Record<string, string> = {
      "1101": `您好！我是您的专业工作总结撰写助手 📊

我擅长撰写周报、月报、季度总结等各类工作总结，帮助您梳理工作内容、提炼核心亮点、展现工作成果。

请告诉我以下信息：
1. 总结类型：周报、月报还是季度总结？
2. 工作内容：这段时间主要完成了哪些工作？
3. 核心成果：有哪些重要的成果或亮点？
4. 数据支撑：是否有相关的数据或指标？
5. 遇到的问题：工作中遇到了哪些困难或挑战？

让我们开始创作一份专业的工作总结吧！✨`,
      "1102": `您好！我是您的专业工作计划撰写助手 📋

我擅长撰写周计划、月计划、季度计划等各类工作计划，帮助您明确目标、规划任务、合理安排时间。

请告诉我以下信息：
1. 计划类型：周计划、月计划还是季度计划？
2. 工作目标：这段时间的主要目标是什么？
3. 重点任务：需要完成哪些重要任务？
4. 时间安排：如何分配时间和资源？
5. 预期成果：期望达成什么样的结果？
...
让我们开始制定一份清晰的工作计划吧！✨`,
      "1103": `您好！我是您的专业项目进度报告撰写助手 📈

我擅长撰写项目进度报告，帮助您清晰展现项目进展、识别风险、提出解决方案。
...
让我们开始撰写项目进度报告吧！✨`,
      "1104": `您好！我是您的专业销售业绩报告撰写助手 💰

我擅长撰写销售业绩报告，帮助您分析销售数据、总结成功经验、制定改进策略。
...
让我们开始撰写销售业绩报告吧！✨`,
      "1105": `您好！我是您的专业财务报告撰写助手 💵

我擅长撰写财务报告，帮助您清晰展现财务状况、分析财务数据、提供决策支持。

请告诉我以下信息：
1. 报告类型：月度、季度还是年度财务报告？
2. 财务数据：收入、支出、利润等关键数据
3. 财务分析：同比、环比等分析
4. 重要事项：需要特别说明的财务事项
5. 财务建议：对未来的财务建议

让我们开始撰写财务报告吧！✨`,
      "1106": `您好！我是您的专业市场分析报告撰写助手 📊

我擅长撰写市场分析报告，帮助您分析市场趋势、竞争格局、提供战略建议。
...
让我们开始撰写市场分析报告吧！✨`,
      "1107": `您好！我是您的专业年度述职报告撰写助手 📝

我擅长撰写年度述职报告，帮助您全面总结年度工作、展现个人成长、规划未来发展。
...
让我们开始撰写年度述职报告吧！✨`,
      "1108": `您好！我是您的专业转正述职报告撰写助手 📄

我擅长撰写转正述职报告，帮助您展现试用期工作成果、体现岗位胜任力、提高转正成功率。
...
让我们开始撰写转正述职报告吧！✨`,
      "1109": `您好！我是您的专业绩效评估报告撰写助手 📑

我擅长撰写绩效评估报告，帮助您客观评价工作表现、识别优势与不足、制定改进计划。

请告诉我以下信息：
1. 评估对象：评估谁的绩效？
2. 评估周期：评估哪个时间段的绩效？
3. 关键指标：主要的绩效指标和完成情况
4. 优势与不足：表现突出和需要改进的地方
5. 改进建议：具体的改进建议

让我们开始撰写绩效评估报告吧！✨`,
      "1110": `您好！我是您的专业绩效改进计划撰写助手 🎯

我擅长撰写绩效改进计划，帮助您明确改进目标、制定行动方案、提升工作绩效。
...
让我们开始制定绩效改进计划吧！✨`,
      "1111": `您好！我是您的专业部门简报撰写助手 📰

我擅长撰写部门简报，帮助您简洁明了地传达部门动态、工作进展、重要信息。
...
让我们开始撰写部门简报吧！✨`,
      "1112": `您好！我是您的专业业务发展计划撰写助手 📈

我擅长撰写业务发展计划，帮助您明确发展方向、制定战略规划、推动业务增长。
...
让我们开始制定业务发展计划吧！✨`
  ...
  const getApiEndpoint = (templateId: string): string => {
    switch (templateId) {
      case "1001": return "/api/report/meeting-invitation";
      case "1002": return "/api/report/meeting-minutes";
      case "1003": return "/api/report/work-email";
      case "1004": return "/api/report/internal-notice";
      case "1005": return "/api/report/external-notice";
      case "1006": return "/api/report/customer-feedback";
      case "1007": return "/api/report/employee-satisfaction";
      case "1008": return "/api/report/emergency-contact";
      case "1009": return "/api/report/daily-report";
      case "1010": return "/api/report/problem-solving";
      case "1011": return "/api/report/proposal";
      case "1012": return "/api/report/thank-you-letter";
      case "1013": return "/api/report/apology-letter";
      default: return "/api/report/meeting-invitation";
    }
  };
