...
import { personalDevelopmentTemplates } from "@/lib/general-templates";
...
export function PersonalDevelopmentWritingPage() {
  const router = useRouter();
  const searchParams = useSearchParams();
  const templateTitle = searchParams.get("title") || "个人发展";
  const templateId = searchParams.get("template") || "1101";
  const source = searchParams.get("source") || "hot"; // 获取source参数

  // 个人发展模块的类型映射函数
  const getPersonalDevelopmentTypeByTemplateId = (templateId: string): ConversationType => {
    const mapping: Record<string, ConversationType> = {
      '1501': 'personal-development-resume-optimization-job',
      '1502': 'personal-development-resume-optimization',
      '1503': 'personal-development-cover-letter',
      '1504': 'personal-development-growth-plan',
      '1505': 'personal-development-skill-improvement',
      '1506': 'personal-development-self-introduction',
      '1507': 'personal-development-career-planning',
      '1508': 'personal-development-goal-setting',
      '1509': 'personal-development-ability-assessment',
      '1510': 'personal-development-learning-resources',
      '1511': 'personal-development-certification-application',
      '1512': 'personal-development-continuing-education',
      '1513': 'personal-development-mentor-guidance',
      '1514': 'personal-development-self-reflection',
      '1515': 'personal-development-career-transition',
      '1516': 'personal-development-personal-branding',
      '1517': 'personal-development-time-management',
      '1518': 'personal-development-goal-tracking',
      '1519': 'personal-development-leadership-development',
    };
    return mapping[templateId] || 'personal-development-resume-optimization-job';
  };
    ...
    if (source === "hot") {
      ...
      switch (platform) {
        case "personal-development":
          return personalDevelopmentTemplates.map((t: any) => ({
            id: t.id,
  ...
  useEffect(() => {
    const loadHistory = async () => {
      ...
      try {
        // 根据当前模板ID获取对应的子类型
        const conversationType = getPersonalDevelopmentTypeByTemplateId(activeTemplate.toString());
  ...
  const getWelcomeMessage = (templateId: string): string => {
    ...
    const welcomeMessages: Record<string, string> = {
      "1501": `您好！我是您的专属求职简历优化专家，拥有50年的职业发展指导经验。我深知一份优秀的简历对于求职成功的重要性。
...
我的工作流程是：
首先，我会了解您的目标岗位、工作经历和核心优势；然后，基于这些信息为您优化简历内容；接下来，我们可以一起对方案进行调整，直到您完全满意。
...
期待帮助您打造一份脱颖而出的求职简历！`,
      "1502": `您好！我是您的专业简历优化助手，拥有丰富的HR和职业规划经验。
...
请告诉我：
1. 您当前的职业状态（在职/离职/应届生）
2. 您的教育背景和工作经历
3. 您希望应聘的岗位类型
4. 您认为简历中需要重点优化的部分

让我们一起打造一份专业的简历！`,
      "1503": `您好！我是您的专业求职信撰写助手，拥有50年的职业咨询经验。
...
让我们开始创作一封打动HR的求职信！`,
      "1504": `您好！我是您的个人成长计划专家顾问，拥有50年的职业发展规划经验。
...
1. 您当前的职业状态和发展阶段
2. 您希望在哪些方面实现成长？
3. 您的短期目标（1年内）和长期目标（3-5年）
4. 您目前面临的主要挑战是什么？

让我们一起规划您的成长之路！`,
      "1505": `您好！我是您的技能提升计划专家，专注于帮助职场人士系统化提升专业能力。
...
让我们开始制定您的技能提升计划！`,
      "1506": `您好！我是您的自我介绍撰写专家，拥有丰富的职场沟通经验。
...
请告诉我：
1. 自我介绍的场景（面试/入职/社交/演讲等）
2. 时长要求（1分钟/3分钟/5分钟等）
3. 您希望突出的核心信息
4. 听众的特点和期待

让我们打造一个令人印象深刻的自我介绍！`,
      "1507": `您好！我是您的职业发展规划专家，拥有50年的职业咨询经验。
...
让我们一起规划您的职业发展蓝图！`,
      "1508": `您好！我是您的个人目标设定专家，专注于帮助您制定科学合理的个人目标。
...
让我们一起设定清晰可行的个人目标！`,
      "1509": `您好！我是您的能力评估专家，拥有丰富的人才测评经验。
...
让我们开始全面评估您的能力！`,
      "1510": `您好！我是您的学习资源规划专家，专注于帮助职场人士找到最适合的学习资源。
...
2. 您的学习目标和期望水平
3. 您的学习时间和预算
4. 您偏好的学习方式（在线/线下/书籍等）

让我们一起打造您的学习资源清单！`,
      "1511": `您好！我是您的职业资格证书申请专家，拥有丰富的证书申请指导经验。
...
让我们开始准备您的证书申请材料！`,
      "1512": `您好！我是您的继续教育规划专家，专注于帮助职场人士制定系统的学习计划。
...
让我们一起规划您的继续教育之路！`,
      "1513": `您好！我是您的导师指导计划专家，拥有丰富的职业辅导经验。
...
让我们一起制定有效的导师指导计划！`,
      "1514": `您好！我是您的自我反思专家，专注于帮助您建立深度思考的习惯。
...
请告诉我：
1. 您希望反思哪些方面？（工作/学习/生活/人际关系等）
2. 您当前面临的主要困惑或挑战
3. 您希望通过反思达成什么目标？
4. 您的反思频率和时间安排

让我们开始建立您的自我反思体系！`,
      "1515": `您好！我是您的职业转型规划专家，拥有50年的职业转型指导经验。
...
让我们一起规划您的职业转型之路！`,
      "1516": `您好！我是您的个人品牌建立专家，专注于帮助职场人士打造专业形象。
...
让我们一起打造您的个人品牌！`,
      "1517": `您好！我是您的时间管理专家，拥有丰富的效率提升经验。
...
让我们一起提升您的时间管理效率！`,
      "1518": `您好！我是您的目标追踪专家，专注于帮助您建立有效的目标管理体系。
...
让我们一起建立您的目标追踪体系！`,
      "1519": `您好！我是您的领导力培养专家，拥有50年的领导力发展经验。
...
让我们一起打造您的领导力培养计划！`
    ...
    return welcomeMessages[templateId] || welcomeMessages["1501"];
  };

  // 初始化欢迎消息（所有个人发展子类型）
  useEffect(() => {
    const personalDevelopmentTemplateIds = ["1501", "1502", "1503", "1504", "1505", "1506", "1507", "1508", "1509", "1510", "1511", "1512", "1513", "1514", "1515", "1516", "1517", "1518", "1519"];
    if (personalDevelopmentTemplateIds.includes(templateId) && messages.length === 0) {
      setMessages([{
        id: 'welcome',
        role: 'assistant',
  ...
  const getApiEndpoint = (templateId: string): string => {
    switch (templateId) {
      case "1501": return "/api/personal-development/resume-optimization-job";
      case "1502": return "/api/personal-development/resume-optimization";
      case "1503": return "/api/personal-development/cover-letter";
      case "1504": return "/api/personal-development/growth-plan";
      case "1505": return "/api/personal-development/skill-improvement";
      case "1506": return "/api/personal-development/self-introduction";
      case "1507": return "/api/personal-development/career-planning";
      case "1508": return "/api/personal-development/goal-setting";
      case "1509": return "/api/personal-development/ability-assessment";
      case "1510": return "/api/personal-development/learning-resources";
      case "1511": return "/api/personal-development/certification-application";
      case "1512": return "/api/personal-development/continuing-education";
      case "1513": return "/api/personal-development/mentor-guidance";
      case "1514": return "/api/personal-development/self-reflection";
      case "1515": return "/api/personal-development/career-transition";
      case "1516": return "/api/personal-development/personal-branding";
      case "1517": return "/api/personal-development/time-management";
      case "1518": return "/api/personal-development/goal-tracking";
      case "1519": return "/api/personal-development/leadership-development";
      default: return "/api/personal-development/resume-optimization-job";
    }
  };
  ...
  const handleCommunicationNewConversation = () => {
    ...
    // 所有个人发展子类型：重置消息列表为对应的欢迎消息
    const personalDevelopmentTemplateIds = ["1501", "1502", "1503", "1504", "1505", "1506", "1507", "1508", "1509", "1510", "1511", "1512", "1513", "1514", "1515", "1516", "1517", "1518", "1519"];
    if (personalDevelopmentTemplateIds.includes(templateId)) {
      setMessages([{
        id: 'welcome-' + Date.now(),
        role: 'assistant',
        content: getWelcomeMessage(templateId),
  ...
  return (
    <div className="flex h-[calc(100vh-56px)]">
      {["1501", "1502", "1503", "1504", "1505", "1506", "1507", "1508", "1509", "1510", "1511", "1512", "1513", "1514", "1515", "1516", "1517", "1518", "1519"].includes(templateId) ? (
        /* 所有个人发展子类型：统一使用对话模式UI */
