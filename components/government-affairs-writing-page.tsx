...
import { government-affairsTemplates } from "@/lib/general-templates";
...
export function GovernmentAffairsWritingPage() {
    ...
    if (source === "hot") {
      ...
      switch (platform) {
        case "government-affairs":
          return government-affairsTemplates.map((t: any) => ({
            id: t.id,
  ...
  const getWelcomeMessage = (templateId: string): string => {
    ...
    const welcomeMessages: Record<string, string> = {
      "2001": `您好！我是您的专属入职欢迎辞专家，拥有50年的落地项目经验。我深知一场真诚而专业的入职欢迎对于新员工融入团队的重要性。
...
期待与您合作，打造一场令人难忘的入职欢迎体验！`,
      "2002": `您好！我是您的专属部门介绍演讲大师，拥有50年的实战项目经验。我专注于帮助您打造专业、有说服力的部门介绍演讲方案。
...
让我们开始打造您的精彩演讲！`,
      "2003": `你好，我是你的项目启动演说大师。这50年来，我见过无数项目起高楼，也见过无数项目宴宾客，区别往往就在启动的那一口气上。
...
请回答以上问题，我们立马开始。`,
      "2004": `您好！我是您的团队建设活动开场白专家顾问，拥有50年项目落地经验。我专注于帮助您设计富有感染力、高参与度的活动开场，让您的团队建设活动从第一分钟就充满活力！
...
让我们开始创作一份专业的转正述职报告演讲稿吧！`
  ...
  // 初始化欢迎消息（所有政务公文子类型）
  useEffect(() => {
    const government-affairsTemplateIds = ["2001", "2002", "2003", "2004", "2005", "2006", "2007", "2008", "2009", "2010", "2011", "2012"];
    if (government-affairsTemplateIds.includes(templateId) && messages.length === 0) {
      setMessages([{
        id: 'welcome',
        role: 'assistant',
  ...
  const handleCommunicationNewConversation = () => {
    ...
    const government-affairsTemplateIds = ["2001", "2002", "2003", "2004", "2005", "2006", "2007", "2008", "2009", "2010", "2011", "2012"];
    if (government-affairsTemplateIds.includes(templateId)) {
      setMessages([{
        id: 'welcome-' + Date.now(),
        role: 'assistant',
        content: getWelcomeMessage(templateId),
