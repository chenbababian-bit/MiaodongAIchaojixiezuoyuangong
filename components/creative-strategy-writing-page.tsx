...
import { creativeStrategyTemplates } from "@/lib/marketing-templates";
...
export function CreativeStrategyWritingPage() {
  const router = useRouter();
  const searchParams = useSearchParams();
  const templateTitle = searchParams.get("title") || "创意策略";
  const templateId = searchParams.get("template") || "11001";
  const source = searchParams.get("source") || "hot"; // 获取source参数

  // 创意策略模块的类型映射函数
  const getCreativeStrategyTypeByTemplateId = (templateId: string): ConversationType => {
    const mapping: Record<string, ConversationType> = {
      '11001': 'creative-strategy-brief',
      '11002': 'creative-strategy-proposal',
    ...
    if (source === "hot") {
      ...
      switch (platform) {
        case "creative-strategy":
          return creativeStrategyTemplates.map((t: any) => ({
            id: t.id,
            icon: "creative-strategy",
            iconBg: t.color,
            title: t.title,
            desc: t.desc,
            active: false,
  ...
  useEffect(() => {
    const loadHistory = async () => {
      ...
      try {
        // 根据当前模板ID获取对应的子类型
        const conversationType = getCreativeStrategyTypeByTemplateId(activeTemplate.toString());
  ...
  const getWelcomeMessage = (templateId: string): string => {
    ...
    const welcomeMessages: Record<string, string> = {
      "11001": `您好！我是您的创意简报大师，拥有50年品牌与创意策略落地经验。我能帮您制定专业的创意简报，挖掘深度受众洞察，提炼核心品牌信息。请告诉我您的项目类型和需求，让我们开始吧！`,
      "11002": `您好！我是您的创意策略提案大师，拥有50年品牌与创意策略落地经验。我擅长品牌战略咨询、创意策略开发和专业提案撰写。请告诉我您的品牌/产品、核心挑战和期望目标。`,
      "11003": `您好！我是您的品牌定位战略大师，拥有50年品牌落地实战经验。我专注于品牌战略定位、创意策略开发和市场分析。请告诉我您目前的品牌建设阶段和核心挑战。`,
      "11004": `您好！我是您的品牌传播策略顾问，拥有50年品牌落地项目经验。我能为您提供品牌战略、创意策略和传播规划服务。请告诉我您的品牌行业、核心产品和传播目标。`,
      "11005": `您好！我是您的品牌创意策略顾问，拥有50年一线品牌创意实战经验。我擅长品牌战略定位、Big Idea创意概念开发和专业提案制作。请告诉我您的品牌挑战和项目目标。`,
      "11006": `您好！我是年度创意计划大师，拥有50年一线实战经验。我能帮您精准诊断品牌问题、制定差异化策略、输出可落地的年度执行计划。请告诉我您的行业、产品、当前挑战和年度目标。`,
      "11007": `您好！我是结构化提示词架构师，拥有50年创意与策略落地经验。我能将您的想法转化为逻辑严密、即插即用的专家级Prompt。请告诉我您想打造什么主题的智能体。`,
      "11008": `您好！我是创意策略工作流大师，拥有50年品牌创意项目落地经验。我横跨品牌战略、创意策略、工作流设计与提案表达四大领域。请告诉我您当前面临的项目挑战或需求。`,
      "11009": `您好！我是您的专属创意审核顾问，拥有50年品牌营销与创意落地经验。我能系统审核创意提案、快速诊断问题、建立标准化审核流程。请告诉我您的品牌定位和需要审核的项目类型。`,
      "11010": `您好！我是创意会议纪要大师，拥有50年品牌创意项目落地经验。我能将复杂的创意讨论整理成清晰可执行的纪要，明确行动项和责任分配。请告诉我会议议题和接收对象。`,
      "11011": `您好！我是创意思维导图大师，拥有50年实战经验。我能用结构化的力量，帮您把脑海中的乱麻织成一张落地的作战地图。请告诉我您想要梳理的主题或面临的核心挑战。`,
      "11012": `您好！我是拥有50年一线品牌操盘经验的战略顾问。我擅长从品牌、创意、市场策略三个维度深度解剖竞品。请告诉我您所在的行业和想要对标的竞品名称。`,
      "11013": `您好！我是品牌创意策略大师，拥有50年真实项目落地经验。我能帮您进行市场趋势洞察、品牌定位提炼和创意策略开发。请告诉我您的品牌和最迫切需要解决的问题。`,
      "11014": `您好！我是创新趋势战略伙伴，拥有50年品牌实战经验与全球趋势洞察能力。我专注于趋势研究、品牌战略和创意策略。请告诉我您所在的行业、核心问题和期望成果。`
    };
